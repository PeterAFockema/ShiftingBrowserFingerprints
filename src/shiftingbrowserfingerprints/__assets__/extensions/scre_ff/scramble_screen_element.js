...
(function() {
  ...
  if (settings.screen) {
    ...
    Object.defineProperty(window, 'screen', {
      get: () => ({
        width: spoofedScreen.width,
        height: spoofedScreen.height,
        availWidth: spoofedScreen.availWidth,
        availHeight: spoofedScreen.availHeight,
        colorDepth: spoofedScreen.colorDepth,
        pixelDepth: spoofedScreen.pixelDepth,
        orientation: { type: 'landscape-primary', angle: 0 }
      })
    });
    Object.defineProperty(window, 'innerWidth', { get: () => spoofedScreen.width });
    Object.defineProperty(window, 'innerHeight', { get: () => spoofedScreen.availHeight });
    Object.defineProperty(window, 'outerWidth', { get: () => spoofedScreen.width });
    Object.defineProperty(window, 'outerHeight', { get: () => spoofedScreen.height });
  }
